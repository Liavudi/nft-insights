...
def get_average_contracts_gas_fee(from_timestamp: float, to_timestamp: float):
    ...
    for transaction_log in transaction_logs:
        ...
        eth_in_usd = es_client.get_eth_price_in_usd(timestamp=decode_from_hex(transaction_log['timeStamp']))
...
if __name__ == '__main__':
    ...
    eth_in_usd = es_client.get_eth_price_in_usd(timestamp='1660770085815')
    app.run(debug=True)
